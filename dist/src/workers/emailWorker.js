...
import { publishNotificationDlq } from "../kafka/notifyProducers.js";
    ...
    await emailConsumer.run({
        eachMessage: async ({ topic, partition, message }) => {
            ...
            try {
                ...
                await sendEmail(normalizedPayload.addr, normalizedPayload.subject || "no-Reply", normalizedPayload.content);
            }
            catch (error) {
