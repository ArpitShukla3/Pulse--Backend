...
import { buildAuthenticatedUser, getRefreshTokenExpiry, getRequestIp, signAccessToken, signRefreshToken, verifyRefreshToken } from "../utils/auth.js";
configDotenv();
const createLoginSession = async ({ userId, deviceType, deviceIP }) => {
    ...
    const nextRefreshToken = existingLogin?.loginId === login.loginId ? refreshToken : signRefreshToken(userId, login.loginId);
